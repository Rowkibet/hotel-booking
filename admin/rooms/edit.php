    ...
    <div class="admin-content">
        ...
        <div class="form-container">
            <div class="auth-form">
                ...
                <form action="edit.php" method="post" enctype="multipart/form-data" novalidate>

                <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>

                <input type="hidden" name="id" value= "<?php echo $room_id ?>" id="">
                    ...
                    <div class="form-control">
                        ...
                        <input type="file" name="room_images" value= "<?php echo $room_images; ?>" id="">
                        <i class="fas fa-check-circle icon"></i>
                        <i class="fas fa-exclamation-circle icon"></i>
                        <small>Error message</small>
                    </div>
                    ...
                    <button type="submit" name="update-room" class="btn submit-btn">Submit</button>
